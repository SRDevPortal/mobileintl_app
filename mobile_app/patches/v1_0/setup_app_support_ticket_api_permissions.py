"""Ensure Support Ticket API role can access App Support Ticket DocTypes."""
...
def execute():
	...
	for doctype in ("App Support Ticket", "App Support Ticket Message"):
		...
		for ptype in ("read", "write", "create", "delete"):
			...
			try:
				...
				frappe.log_error(title=f"App Support Ticket API perm: {doctype}.{ptype}")
