...
frappe.provide("mobileintl_app.clinical_ui");
...
mobileintl_app.clinical_ui.render_clinical_table = function (columns, rows) {
...
mobileintl_app.clinical_ui.get_patient_display_name = function (frm) {
...
mobileintl_app.clinical_ui.render_patient_header = function (frm) {
	frm.$wrapper.find(".ma-clinical-header-mount").remove();
	const profile = get_primary_profile(frm);
	const display_name = mobileintl_app.clinical_ui.get_patient_display_name(frm);
...
mobileintl_app.clinical_ui.render_profile_panel = function (frm) {
...
mobileintl_app.clinical_ui.render_medical_summary = function (frm) {
	render_summary_panel(
		frm,
		"medical_section",
...
mobileintl_app.clinical_ui.render_health_workspace = function (frm) {
	...
	if (!entries.length) {
		...
		function render_tool(key) {
			...
			$panelBody.empty().append(mobileintl_app.clinical_ui.render_clinical_table(cols, rows));
		}
...
mobileintl_app.clinical_ui.enhance_appointments = function (frm) {
...
mobileintl_app.clinical_ui.setup = function (frm) {
	if (frm.is_new()) return;
	...
	mobileintl_app.clinical_ui.render_patient_header(frm);
	mobileintl_app.clinical_ui.enhance_appointments(frm);
