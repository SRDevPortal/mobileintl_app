...
const API = "mobileintl_app.mobileapp.page.doctor_clinical.doctor_clinical";
const CSS_PATH = "/assets/mobileintl_app/css/doctor_clinical.css";
...
function is_doctor_clinical_route(route) {
	if (mobileintl_app.doctor_clinical.is_doctor_clinical_route) {
		return mobileintl_app.doctor_clinical.is_doctor_clinical_route(route);
	}
...
function teardown_doctor_portal() {
	if (mobileintl_app.doctor_clinical.teardown_doctor_portal) {
		mobileintl_app.doctor_clinical.teardown_doctor_portal();
		return;
	}
...
frappe.pages["doctor-clinical"].on_page_load = function (wrapper) {
	frappe.require(CSS_PATH, () => {
		const portal = new mobileintl_app.doctor_clinical.DoctorClinicalPortal(wrapper);
		mobileintl_app.doctor_clinical.portal = portal;
		portal._route_key = "";
...
frappe.pages["doctor-clinical"].on_page_show = function () {
	if (mobileintl_app.doctor_clinical.portal) {
		mobileintl_app.doctor_clinical.portal._route_key = "";
		mobileintl_app.doctor_clinical.portal.on_route_change();
	}
};
...
mobileintl_app.doctor_clinical.DoctorClinicalPortal = class DoctorClinicalPortal {
	constructor(wrapper) {
